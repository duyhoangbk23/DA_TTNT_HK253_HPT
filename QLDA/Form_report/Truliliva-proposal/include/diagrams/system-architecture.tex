...
\node[box] (sim) {Simulator ESP32\\\texttt{mcu\_id, telemetry.tds}\\Implemented};
...
\node[box,below=24mm of sim] (firmware) {Firmware chính\\\texttt{mcu\_id, telemetry}\\Contract canonical};
...
\draw[flow] (firmware.east) -| node[pos=0.22,below]{TLS} (broker.south);
