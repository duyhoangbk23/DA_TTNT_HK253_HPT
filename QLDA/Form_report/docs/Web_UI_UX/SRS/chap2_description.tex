...
Hệ thống được phát triển như một ứng dụng Web độc lập theo mô hình Client -- Server.

Người dùng truy cập hệ thống thông qua trình duyệt Web. Mọi yêu cầu từ giao diện người dùng sẽ được gửi đến Web Server, nơi ứng dụng PHP xử lý nghiệp vụ và thực hiện các thao tác với cơ sở dữ liệu MySQL trước khi trả kết quả về giao diện.

Để xây dựng giao diện quản trị hiện đại và đồng nhất, hệ thống sử dụng FlexAdmin Dashboard Template kết hợp với Bootstrap 5 nhằm tăng khả năng Responsive và cải thiện trải nghiệm người dùng.

Trong định hướng phát triển tương lai, hệ thống có thể tích hợp với nền tảng IoT để tiếp nhận dữ liệu từ các thiết bị máy lọc nước thông qua giao thức MQTT. Các dữ liệu này sẽ được lưu trữ trong cơ sở dữ liệu và hiển thị dưới dạng Dashboard theo từng thiết bị.
...
\hline
Framework giao diện & Bootstrap 5 \\
\hline
Admin Template & FlexAdmin Dashboard Template \\
\hline
