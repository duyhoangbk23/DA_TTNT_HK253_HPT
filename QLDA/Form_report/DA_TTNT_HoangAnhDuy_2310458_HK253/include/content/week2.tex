...
\tocsubsubsection{2.1 Mô tả công việc}
...
\tocsubsubsection{2.2 Nghiên cứu hồ sơ đề xuất kĩ thuật}
...
\tocsubsubsubsection{Mục tiêu nghiên cứu}
...
\tocsubsubsubsection{Phạm vi nghiên cứu}
...
\tocsubsubsection{2.3 Mô hình tổng thể hệ thống}
...
\tocsubsubsection{2.4 Core System}

\tocsubsubsubsection{Vai trò}
...
\tocsubsubsubsection{Các phân hệ chính}
...
\tocsubsubsubsection{Mối liên kết giữa các phân hệ}
...
\tocsubsubsection{2.5 Omnichannel Integration}
...
\tocsubsubsection{2.6 Field Service \& IoT}

\tocsubsubsubsection{Vai trò của Field Service và IoT}
...
\tocsubsubsubsection{Kiến trúc IoT bốn lớp}
...
\tocsubsubsubsection{Quy trình hệ thống giám sát máy lọc nước}
...
\tocsubsubsubsection{Phân tích quy trình truyền dữ liệu}
...
\tocsubsubsubsection{Đánh giá dưới góc nhìn sinh viên thực tập}
