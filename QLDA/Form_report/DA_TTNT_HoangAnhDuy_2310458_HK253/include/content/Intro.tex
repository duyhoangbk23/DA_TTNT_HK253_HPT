...
Trong thời gian thực tập tại HPT, sinh viên được tìm hiểu môi trường làm việc thực tế của doanh nghiệp, nghiệp vụ của nhân việc, quy trình quản lý dự án, các hoạt động quản lý chất lượng, quản lý rủi ro và phối hợp với khách hàng trong quá trình triển khai dự án.
