\subsubsubsection*{6.2.6 Hoàn thiện ứng dụng quản trị SmartWater}

Song song với chức năng giám sát, sinh viên hoàn thiện ứng dụng SmartWater Admin nhằm hỗ trợ quản lý thông tin và vận hành nội bộ. Ứng dụng tập trung vào các nhóm chức năng chính gồm tổng quan hệ thống, quản lý danh mục và kho, quản lý khách hàng và hợp đồng, theo dõi thiết bị, cùng các chức năng hỗ trợ vận hành.

\subsubsubsection*{6.2.6.1 Xác thực và dashboard tổng quan}
...
\subsubsubsection*{6.2.6.2 Quản lý danh mục, sản phẩm và kho}
...
\subsubsubsection*{6.2.6.3 Quản lý khách hàng và hợp đồng}
...
\subsubsubsection*{6.2.6.4 Quản lý thiết bị và giám sát vận hành}
...
\subsubsubsection*{6.2.6.5 Hỗ trợ vận hành và hồ sơ người dùng}
