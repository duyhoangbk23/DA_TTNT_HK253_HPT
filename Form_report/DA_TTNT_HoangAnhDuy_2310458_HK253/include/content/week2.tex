...
\subsubsection{NỘI DUNG CÔNG VIỆC}
...
\begin{table}[H]
    \centering
    \caption{Nội dung công việc tuần 2}
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}p{1.2cm}|X|}
        \hline
        \textbf{STT} & \textbf{Nội dung thực hiện} \\ \hline
        1 & Nghiên cứu hồ sơ đề xuất kỹ thuật của dự án. \\ \hline
        2 & Tìm hiểu mô hình tổng thể của dự án. \\ \hline
        3 & Tìm hiểu kiến trúc giải pháp ở mức tổng quan. \\ \hline
        4 & Tìm hiểu quy trình nghiệp vụ chính của hệ thống. \\ \hline
        5 & Tìm hiểu các thành phần chính của hệ thống. \\ \hline
        6 & Hiểu mối liên kết giữa các thành phần trong hệ thống. \\ \hline
    \end{tabularx}
\end{table}
